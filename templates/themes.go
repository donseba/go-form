...
var BootstrapTheme = ThemeClasses{
	...
	Required:    StyleOption{Class: "text-danger"},
	...
	RangeValue:      StyleOption{Class: "small text-muted"},
	...
	FormLegend:  StyleOption{Class: "mb-0"},
...
var TailwindTheme = ThemeClasses{
	...
	Required:    StyleOption{Class: "text-red-600"},
	...
	RadioGroup:      StyleOption{Class: "flex flex-wrap gap-3"},
	...
	RangeWrapper:    StyleOption{},
	RangeValue:      StyleOption{Class: "text-sm text-gray-500"},
	...
	FormLegend:  StyleOption{Class: "text-sm font-semibold text-gray-900"},
...
var TailwindV4Theme = ThemeClasses{
	...
	Wrapper:     StyleOption{Class: "mb-2"},
	Label:       StyleOption{Class: "block text-sm font-medium leading-6 text-gray-900"},
	Required:    StyleOption{Class: "text-red-600 dark:text-red-400"},
	...
	RangeWrapper:    StyleOption{},
	RangeValue:      StyleOption{Class: "text-sm text-gray-500 dark:text-gray-300"},
	...
	FormLegend:  StyleOption{Class: "text-sm font-semibold text-gray-900 dark:text-gray-100"},
	FormBody:    StyleOption{Class: "p-4"},
